...
**Live Demo:** [Переглянути сайт](https://seabattle-vue.onrender.com/) 
* Через особливості безкоштовного хостингу Render перший запуск гри може тривати до 1 хвилини
...
* *(Можна додати)* **SQLite** — база даних для збереження статистики ігор.
